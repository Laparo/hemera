...
function ErrorContent() {
  ...
  switch (error) {
    ...
    case 'VerificationError':
      message =
        'Der Magic-Link ist ungültig oder abgelaufen. Bitte fordere einen neuen Link an.';
      break;
    case 'OAuthAccountNotLinked':
      message =
        'Dieses E-Mail-Konto ist bereits mit einem anderen Anbieter verknüpft. Bitte melde dich mit dem verknüpften Anbieter an.';
      break;
    case 'AccessDenied':
