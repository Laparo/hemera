...
-- Index for upcoming courses query (getNextUpcomingCourse)
CREATE INDEX IF NOT EXISTS "courses_upcoming_idx" ON "courses" ("isPublished", "date") WHERE "isPublished" = true AND "date" >= NOW();
